...
public class StartClient extends Thread{
	...
	private final int PORT=6020;
	private final String ADRESS="127.0.0.1";
	
	public StartClient(String caption,Client main)
	{
		super(caption);
		this.Main=main;
	}
	...
	public void displayPacketDetails(DatagramPacket packet) {
	    ...
	    Main.Println("[Server at IP  Address=" + remoteAddr + ", port="
	        + remotePort + "]: " + msg);
	  }
	  public  DatagramPacket getPacket(String msg)
	    ...
	    InetAddress serverIPAddress = InetAddress.getByName(ADRESS);
